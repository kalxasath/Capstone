 ...
 * Defining the ImagesContract class
 * In this table will be stored the Images
 */
public class ImagesContract {


    // Define the possible paths for accessing data in this contract
    // This is the path for the "Images" directory, that will be appended
    ...
    public static final class ImagesEntry implements BaseColumns {
		 ...
		 * Vehicle, Event
		 */
        public static final String COLUMN_NAME_ENTITY_KIND = "entityKind";
